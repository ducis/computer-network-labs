...
$ns duplex-link-op $node5 $node3 orient left-up
...
$udp5 set fid_ 3	# red color
$ns attach-agent $node5 $udp5
...
$cbr5 set packetSize_ $packetSize
$cbr5 set rate_ 0.4Mb
